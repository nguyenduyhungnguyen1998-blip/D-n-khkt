(function() {
    ...
    function addPoleListeners(poleElement) {
        ...
        if (poleElement.dataset.hasListeners) return;
        poleElement.dataset.hasListeners = 'true';
    ...
    function loadGameState() {
        try {
            ...
            document.querySelectorAll('.pole').forEach(p => {
                 ...
                 delete p.dataset.hasListeners; // Reset flag vì innerHTML mới
                 addPoleListeners(p);
            });
